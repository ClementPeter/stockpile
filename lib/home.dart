      ...
      return CustomFloatingActionButton(
        ...
        body: Scaffold(
          appBar: AppBar(
            ...
            title: const Text(
              "StockPile",
              // style: appThemeMode.isDarkModeEnabled
              //     ? GoogleFonts.raleway(
              //         textStyle: TextStyle(color: AppTheme.lightColor),
              //         fontWeight: FontWeight.bold,
              //         fontSize: 24,
              //       )
              //     : GoogleFonts.raleway(
              //         textStyle: const TextStyle(color: AppTheme.lightColor),
              //         fontWeight: FontWeight.bold,
              //         fontSize: 24,
              //       )
          ...
          body: Center(
            child: Consumer(builder: (context, ref, child) {
              ...
              return pileItemModel.pileAmount == 0
                  ? Column(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Center(
                              child: Text("Add a Pile to your StockPile",
                                  style: appThemeMode.isDarkModeEnabled
                                      ? GoogleFonts.raleway(
                                          textStyle: const TextStyle(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (updatedPileItem!.name != "") {
                                      pileItemModel.updatePile(updatedPileItem);
                                    }
                                  },
                                  child: Text(
